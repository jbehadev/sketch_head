...
def index():
    def create_event():
        ...
        event.extend(right_eye_color)
        event.append('|')
        event.append('T')
        event.append(tilt_slider.value)
        event.append('|')
        event.append('S')
        event.append(swivel_slider.value)
        event.append('|')
        event.append('D')
        event.append(duration_slider.value)
        event.append('|')
        event.append('E')
        return event
